...
export default function Tech() {
  const navigation = useNavigation();
    ...
    useEffect(() => {
        axios
        .get("http://newsserver.abhiyanta.co/api/categorywise_articles/sports")
        .then((response) => {
    ...
    return (
        ...
        <SafeAreaView style={styles.container}>
          <ScrollView>
          <View>
                            <Text style={styles.trendinghead}> Technologies Categories</Text>
                        </View>
      
                    {
            sportList.map((item)=>
            <TouchableHighlight   underlayColor={'transparent'} onPress={()=> navigation.navigate("TechDetails",item)}>
    <Card>
